...
const WarehouseForm = (props) => {
    ...
    const [warehouseValue, setWarehouseValue] = useState({
        ...
        role_id: singleWarehouse ? singleWarehouse[0].role_id : ''
    });
    ...
    const onRolesChange = (event) => {
        setWarehouseValue(warehouseValue => ({ ...warehouseValue, role_id: event.target.value }))
        setErrors('');
    };
                ...
                <Form>
                    <div className='row'>
                        ...
                        <div className='col-md-6'>
                            <label
                                className='form-label'>
                                {getFormattedMessage('warehouse.input.role.label')}:
                            </label>
                            <span className='required' />
                            <select name="role_id" id='role' className='form-control' onChange={onRolesChange} value={warehouseValue.role_id}>
