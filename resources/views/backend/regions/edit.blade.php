                            ...
                            <form method="POST" action="{{ route('region.update', $region->id) }}" id="delivery_create">
                                ...
                                <div class="mb-5">
                                    <div class="ms-3 form-check form-switch">
                                        <input class="form-check-input" name="cod" type="checkbox" role="switch"
                                            id="flexSwitchCheckChecked" value="1"
                                            {{ $region->cod == 1 ? 'checked' : '' }}>
                                        <label class="form-check-label" for="flexSwitchCheckChecked">Cash On
                                            Delivery</label>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name"
                                        value="{{ old('name', $region->name) }}" placeholder="Eg. region .....">
                                </div>
                                <div class="text-end submit-m-btn">
                                    <button type="submit" class="btn btn-primary submit-btn">အသစ်ပြုလုပ်မည်</button>
                                </div>
                            </form>
                        </div>
                    </div>
