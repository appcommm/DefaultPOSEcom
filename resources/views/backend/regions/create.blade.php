        ...
        <div class="card my_card">
            <div class="card-header bg-transparent">
                <a href="{{ URL::previous() }}" class="card-title mb-0 d-inline-flex align-items-center create_title">
                    ...
                    <span class="create_sub_title">Regions အသစ်ဖန်တီးမည်</span>
                </a>
            </div><!-- end card header -->
            <div class="card-body">
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-9">
                        <form method="POST" action="{{route('region.store')}}" id="delivery_create">
                            @csrf
                            <div class="mb-5">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Eg. region .....">
                            </div>
