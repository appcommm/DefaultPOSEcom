            ...
            <div class="d-flex align-items-center">
                ...
                {{-- <div class="dropdown topbar-head-dropdown ms-1 header-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0 overflow-hidden" aria-labelledby="page-header-notifications-dropdown" style="border-color:transparent;border-radius: 15px">
                        ...
                        <div class="dropdown-head bg-pattern rounded-top" style="background: #000;">
                            <div class="p-3">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ auth()->guard('dashboard')->user()->name ?? (auth()->guard('web')->user()->first_name . ' ' . auth()->guard('web')->user()->last_name) }}</span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome {{ auth()->guard('dashboard')->user()->name ?? auth()->guard('web')->user()->first_name }}!</h6>
                        ...
                        <a class="dropdown-item" href="{{ route('dashboard.logout') }}" id="logoutBtn" onclick="return confirm('Are you sure you want to logout?')"><i
