...
@section('content')
    ...
    <div class="card-header d-flex justify-content-between align-items-center bg-transparent">
        <h5 class="mb-0 text-dark">Payments - <div class="badge badge-myColor" id="badgeTotalCount">{{ App\Models\Payment::activePayment()->count() }}</div></h5>
    ...
    <script>
      $(document).ready(function() {
            let table = $('#datatable').DataTable( {
                ...
                serverSide: true,
                responsive: true,
                ajax: "/dashboard/payments/datatable/ssd",
                language : {
