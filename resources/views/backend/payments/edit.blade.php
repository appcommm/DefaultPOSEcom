        ...
        <div class="card my_card">
            <div class="card-header bg-transparent">
                <a href="{{route('payment')}}" class="card-title mb-0 d-inline-flex align-items-center create_title">
                    ...
                    <span class="create_sub_title">Payment ကိုပြုပြင်မည်</span>
                </a>
            </div><!-- end card header -->
            <div class="card-body">
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-9">
                        ...
                        <form method="POST" action="{{route('payment.update', $payment->id)}}" id="payment_update" enctype="multipart/form-data">
                            @csrf
                            <div class="upload mb-3">
                                <div class="preview_img">
                                    @if ($payment->payment_logo)
                                        <img src="{{$payment->payment_logo}}" alt="" width=150 height=150 alt="">
                                    @endif
                                </div>
                                <div class="round">
                            ...
                            <div class="text-end submit-m-btn">
                                <button type="submit" class="btn btn-primary submit-btn">ပြင်ဆင်မှုများကိုသိမ်းမည်</button>
                            </div>
                        </form>
                    </div>
                </div>
