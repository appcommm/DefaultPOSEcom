...
@section('content')
    <div class="card order my_card">
        <div class="card-header d-flex justify-content-between py-4 align-items-center bg-transparent">
            <h5 class="mb-0 text-capitalize text-dark">Refund Orders - <div class="badge badge-myColor">{{ App\Models\Order::where('refund_date','!=',null)->count() }}</div></h5>
        </a>
    </div>
    ...
    <script>
      $(document).ready(function() {
            let table = $('#datatable').DataTable( {
                ...
                responsive: true,
                ajax: {
                    url: `/dashboard/refund-orders/datatable/ssd`,
                },
                language : {
