...
use App\Http\Requests\Dashboard\UpdatePaymentRequest;
...
class PaymentController extends Controller
{
    ...
    {
        $payment = Payment::activePayment()->orderBy('id', 'desc')->get();
        return datatables($payment)
            ->addColumn('image', function ($each) {
                return '<img src="' . $each->payment_logo . '" class="thumbnail_img" style="width: 45px;" />';
            })
