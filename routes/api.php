...
Route::middleware('auth:sanctum')->group(function () {
    //    Route::middleware('permission:manage_brands')->group(function () {
        ...
        Route::post('/brand-bulk-store', [BrandAPIController::class, 'bulkStore']);
    ...
    Route::post('/sale-bulk-store', [SaleAPIController::class, 'bulkStore']);
    ...
    Route::post('bulk-holds', [HoldAPIController::class, 'bulkStore']);
    ...
    Route::post('/sales-return-bulk-store', [SaleReturnAPIController::class, 'bulkStore']);
